...
export default async function QuemSomos() {
  ...
  const fallback = [
    { id: 1, nome: "Ana Souza", cargo: "Editora-chefe", bio: "15 anos de experiência em jornalismo político e investigativo.", fotoUrl: "", email: "ana@portal.com.br" },
    { id: 2, nome: "Carlos Lima", cargo: "Editor de Economia", bio: "Especializado em cobertura econômica e mercado financeiro.", fotoUrl: "", email: "carlos@portal.com.br" },
    { id: 3, nome: "Maria Santos", cargo: "Jornalista", bio: "Cobre pautas sociais, direitos humanos e políticas públicas.", fotoUrl: "", email: "maria@portal.com.br" },
    { id: 4, nome: "Pedro Alves", cargo: "Repórter", bio: "Fotojornalista especializado em cultura e meio ambiente.", fotoUrl: "", email: "pedro@portal.com.br" },
  ]
    ...
    <>
      ...
      <div className="w-portal" style={{ paddingBottom: 60 }}>
        ...
        <div style={{ background: "var(--azul-claro)", border: "1px solid var(--borda)", borderLeft: "4px solid var(--azul)", borderRadius: "0 6px 6px 0", padding: "24px 28px", maxWidth: 600 }}>
          ...
          <a href="mailto:redacao@portal.com.br" style={{ display: "inline-block", background: "var(--azul)", color: "#fff", fontSize: 13, fontWeight: 600, padding: "8px 18px", borderRadius: 3, textDecoration: "none" }}>
            Enviar candidatura
          </a>
        </div>
      </div>
