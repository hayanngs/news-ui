...
// Ícones SVG das redes sociais — sem dependência externa
...
const redes: Rede[] = [
  {
    nome: "Instagram",
    href: "https://instagram.com/diariogoiano.oficial",
    svg: (
  ...
  {
    nome: "TikTok",
    href: "https://tiktok.com/@diariogoiano",
    svg: (
  ...
  {
    nome: "YouTube",
    href: "https://youtube.com/@diariogoiano",
    svg: (
  ...
  {
    nome: "Facebook",
    href: "https://facebook.com/diariogoiano",
    svg: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
// ── Versão para Navbar (ícones brancos sobre fundo azul) ──
...
// ── Versão para Footer (ícones brancos menores) ──
